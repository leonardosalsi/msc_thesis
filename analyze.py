...
def prepare_training_data_for_visualisation():
    data_location = "/shared/logs/baseline/"
    _data = {}
...
def visualize_mcc_per_task(data):
    ...
    plt.savefig('/shared/img/eval_mcc.svg')
...
def visualize_mcc_across_tasks(data):
    ...
    ax.set_ylim(0, 1)
    plt.savefig('/shared/img/mcc_across_tasks.svg')
...
def visualize_normalized_mcc_across_tasks(data):
    ...
    ax.set_ylim(0, 1)
    plt.savefig('/shared/img/norm_mcc_across_tasks.svg')

...
#SBATCH --job-name=logan_ewc_0_5
#SBATCH --output=/cluster/home/salsil/msc_thesis_root/out/logan_ewc_0_5.txt
...
--gradient-accumulation 10 --max-workers 4 --load-from-json --ewc-lambda 0.5 \

...
#SBATCH --job-name=default_mean
#SBATCH --output=/cluster/home/salsil/msc_thesis_root/out/default_mean.txt
...
--original-dataset InstaDeepAI/multi_species_genomes --model-name default_logan_ewc_25_pca_mean_256 \

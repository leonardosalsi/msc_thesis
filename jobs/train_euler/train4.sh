...
#SBATCH --job-name=logan_ewc_10
#SBATCH --output=/cluster/home/salsil/msc_thesis_root/out/logan_ewc_10.txt
...
--gradient-accumulation 10 --max-workers 4 --load-from-json --ewc-lambda 10 \

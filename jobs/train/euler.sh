...
#SBATCH --job-name=train_overlap_ewc_25
#SBATCH --output=/cluster/home/salsil/msc_thesis_root/out/train_overlap_ewc_25.txt
...
--gradient_accumulation 10 --max_workers 4 --ewc_lambda 25 --load_from_json \

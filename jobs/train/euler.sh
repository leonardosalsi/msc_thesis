...
#SBATCH --job-name=train_overlap_pca_128
#SBATCH --output=/cluster/home/salsil/msc_thesis_root/out/train_overlap_pca_128.txt
...
--gradient_accumulation 10 --max_workers 4 --pca_embeddings --pca_dim 128
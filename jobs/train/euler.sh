...
#SBATCH --job-name=128_ewc_pca
#SBATCH --output=/cluster/home/salsil/msc_thesis_root/out/logan_ewc_pca_128.txt
...
--original_dataset /cluster/scratch/salsil/multi_genome_species/1k --pca_embeddings --pca_dim 128
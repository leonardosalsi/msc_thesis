...
accelerate launch --num_processes 5 --num_machines 1 --mixed_precision no --dynamo_backend yes /cluster/home/salsil/msc_thesis_root/msc_thesis/train_model.py \
/cluster/scratch/salsil/multi_genome_species/1k  overlapping \
--compile_model --logging_steps 1 --train_size 10 --eval_size 32 \
--gradient_accumulation 10 --max_workers 4 --ewc_lambda 10 \

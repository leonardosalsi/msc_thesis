...
#SBATCH --job-name=256_mean
#SBATCH --output=/cluster/home/salsil/msc_thesis_root/out/256_mean.txt
...
--gradient-accumulation 20 --max-workers 4 --pca-embeddings mean --pca-dim 256
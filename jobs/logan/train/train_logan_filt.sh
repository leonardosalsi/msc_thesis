...
#SBATCH --job-name=tr_logan_filt_v100
#SBATCH --output=/cluster/work/grlab/projects/projects2024-petagraph-input-optimisation-msc-thesis/out/train_logan_filt_v100.txt

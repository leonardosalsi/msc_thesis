...
#SBATCH --job-name=stat_logan_1k
#SBATCH --output=/cluster/work/grlab/projects/projects2024-petagraph-input-optimisation-msc-thesis/out/stat_logan_1k.txt
...
--chunk_size 1200 \
--reverse_complement --max_workers 8 --acc_column acc --group_id_column kmeans --run_statistics --file_level
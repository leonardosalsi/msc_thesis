...
sbatch jobs/evaluate_trained_modelId_1/promoter_all.sh
sbatch jobs/evaluate_trained_modelId_1/promoter_tata.sh
sbatch jobs/evaluate_trained_modelId_1/promoter_no_tata.sh
sbatch jobs/evaluate_trained_modelId_1/enhancers.sh
sbatch jobs/evaluate_trained_modelId_1/enhancers_types.sh
sbatch jobs/evaluate_trained_modelId_1/splice_sites_all.sh
...
sbatch jobs/evaluate_trained_modelId_1/H3K9ac.sh
sbatch jobs/evaluate_trained_modelId_1/H3K9me3.sh
sbatch jobs/evaluate_trained_modelId_1/H4K20me1.sh
sbatch jobs/evaluate_trained_modelId_1/gb_human_ensembl_regulatory.sh
sbatch jobs/evaluate_trained_modelId_1/gb_demo_human_or_worm.sh
sbatch jobs/evaluate_trained_modelId_1/gb_human_ocr_ensembl.sh
sbatch jobs/evaluate_trained_modelId_1/gb_drosophila_enhancers_stark.sh
sbatch jobs/evaluate_trained_modelId_1/gb_dummy_mouse_enhancers_ensembl.sh
sbatch jobs/evaluate_trained_modelId_1/gb_demo_coding_vs_intergenomic_seqs.sh

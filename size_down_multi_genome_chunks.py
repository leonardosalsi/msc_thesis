...
if __name__ == "__main__":
    ...
    chunk_size_filename = str(chunk_size/1000).replace(".", "_") + "kbp"
    split_dataset_dir = os.path.join(datasets_cache_dir, f'InstaDeepAI___multi_species_genomes/{chunk_size_filename}/',
                                     split)
    ...
    new_train_dataset = Dataset.from_generator(lambda: split_dataset(multi_species_genomes, chunk_size))

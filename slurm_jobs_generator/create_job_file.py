...
from slurm_jobs_generator._evaluate_pretrained_job import ask_evaluation_trained
...
if __name__ == "__main__":
    ...
    print("Generate jobs for training [1], model evaliation by MCC [2], dataset chunk downsizing [3] or evaluation of continued trained models [4]?")
    mode = ""
    while True:
        ans = input("> ")
        if ans == "1":
            ...
            ask_evaluation_trained(parent_folder)
            break
        else:

...
PRETRAINED_MODELS = [
    ...
    {'modelId': 2,'repo': "InstaDeepAI/nucleotide-transformer-v2-50m-multi-species", 'name': 'nucleotide-transformer-v2-50m-multi-species-sh-1-35-1-8-gc-0-4-0-6-12B', 'data_alias': 'NT-MS V2 (50M) (Shannon 1.35-1.8, GC 0.4-0.6, 12B)' ,'tokenizer': "InstaDeepAI/nucleotide-transformer-v2-50m-multi-species", 'checkpoint': 'overlappingesmtokenizerwithnskipping_multi_genome_dataset_1_2kbp_sh_1_35_1_8_gc_0_4_0_6/checkpoint-12000/'},
]

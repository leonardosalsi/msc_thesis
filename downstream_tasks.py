...
PRETRAINED_MODELS = [
    {'modelId': 0,'repo': "InstaDeepAI/nucleotide-transformer-v2-50m-multi-species", 'name': 'nucleotide-transformer-v2-50m-multi-species-sh-1-35-1-8-gc-0-4-0-6-6B', 'data_alias': 'NT-MS V2 (50M)' ,'tokenizer': "InstaDeepAI/nucleotide-transformer-v2-50m-multi-species", 'checkpoint': 'InstaDeepAI/nucleotide-transformer-v2-50m-multi-species'},
    {'modelId': 1,'repo': "InstaDeepAI/nucleotide-transformer-v2-50m-multi-species", 'name': 'nucleotide-transformer-v2-50m-multi-species-sh-1-35-1-8-gc-0-4-0-6-6B', 'data_alias': 'NT-MS V2 (50M) (Overlapping, Shannon 1.35-1.8, GC 0.4-0.6, 6B)' ,'tokenizer': "InstaDeepAI/nucleotide-transformer-v2-50m-multi-species", 'checkpoint': 'overlappingesmtokenizerwithnskipping_multi_genome_dataset_1_2kbp_sh_1_35_1_8_gc_0_4_0_6/checkpoint-6000/'},
    {'modelId': 2,'repo': "InstaDeepAI/nucleotide-transformer-v2-50m-multi-species", 'name': 'nucleotide-transformer-v2-50m-multi-species-sh-1-35-1-8-gc-0-4-0-6-12B', 'data_alias': 'NT-MS V2 (50M) (Overlapping, Shannon 1.35-1.8, GC 0.4-0.6, 12B)' ,'tokenizer': "InstaDeepAI/nucleotide-transformer-v2-50m-multi-species", 'checkpoint': 'overlappingesmtokenizerwithnskipping_multi_genome_dataset_1_2kbp_sh_1_35_1_8_gc_0_4_0_6/checkpoint-12000/'},
    {'modelId': 3,'repo': "InstaDeepAI/nucleotide-transformer-v2-50m-multi-species", 'name': 'nucleotide-transformer-v2-50m-multi-species-sh-1-35-1-8-gc-0-4-0-6-6B', 'data_alias': 'NT-MS V2 (50M) (Default, Shannon 1.35-1.8, GC 0.4-0.6, 6B)' ,'tokenizer': "InstaDeepAI/nucleotide-transformer-v2-50m-multi-species", 'checkpoint': 'default_multi_genome_dataset_1_2kbp_sh_1_35_1_8_gc_0_4_0_6/checkpoint-6000/'},
    {'modelId': 4,'repo': "InstaDeepAI/nucleotide-transformer-v2-50m-multi-species", 'name': 'nucleotide-transformer-v2-50m-multi-species-sh-1-35-1-8-gc-0-4-0-6-12B', 'data_alias': 'NT-MS V2 (50M) (Default, Shannon 1.35-1.8, GC 0.4-0.6, 12B)' ,'tokenizer': "InstaDeepAI/nucleotide-transformer-v2-50m-multi-species", 'checkpoint': 'default_multi_genome_dataset_1_2kbp_sh_1_35_1_8_gc_0_4_0_6/checkpoint-12000/'},
]
